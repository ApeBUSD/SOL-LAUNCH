...
contract ApeBUSD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ApeBUSD", "APEBUSD"){
        address newOwner = address(0xC7D8C9050C39918BB3025f687555c30e69095780); // update to 0xC7D8C9050C39918BB3025f687555c30e69095780
        ...
        marketingPenaltySellFee = 1000;
        liquidityPenaltySellFee = 200;
    	...
    	marketingWallet = address(0x55151Bd404BC452771C63fE0376FE985ba54C4d8); // set as marketing wallet
        charityWallet = address(0xbEc867Ee2A9bE110ea3D64bEd31Fe729A75f806E); // set as charity wallet
        liquidityWallet = address(0x88690AeE61603d262aEEe466411FEbf8Ac16a7f4); // set as liquidity wallet
